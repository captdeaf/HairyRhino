/**
 * defClass( ) -- a utility function for defining JavaScript classes.
 *
...
function defClass(data) {
  ...
  for(var p in getters) proto.__defineGetter__(p,getters[p]);
  for(var p in setters) proto.__defineSetter__(p,setters[p]);
